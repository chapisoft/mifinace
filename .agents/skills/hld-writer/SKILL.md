...
name: hld-writer
description: >-
  Kỹ năng chuyên sâu để phân tích, thiết kế và soạn thảo Tài liệu Thiết kế Tổng thể (High-Level Design - HLD) theo chuẩn quy trình phát triển phần mềm Tập đoàn Viettel (BM.02.QT.00.CNTT.28).
  Sử dụng kỹ năng này khi người dùng yêu cầu: viết tài liệu HLD, viết tài liệu thiết kế tổng thể, lập bảng định cỡ tải hệ thống (Capacity Sizing), lập bảng cấu hình máy chủ dải trong/dải ngoài (Server Hardware Sizing), phân rã phân hệ chức năng, thiết kế tích hợp hệ thống ngoài (VSA Admin, SMSGW, Core eWallet, BCCS), hoặc thiết kế kiến trúc an toàn thông tin ATTT Viettel.
---

# KỸ NĂNG SOẠN THẢO TÀI LIỆU THIẾT KẾ TỔNG THỂ VIETTEL (HLD-WRITER)

Kỹ năng này cung cấp quy trình tác nghiệp chuẩn 5 bước để phân tích, xây dựng và hoàn thiện **Tài liệu Thiết kế Tổng thể (High-Level Design - HLD)** theo đúng biểu mẫu và quy chuẩn nghiêm ngặt của Tập đoàn Viettel (`BM.02.QT.00.CNTT.28`).

---

## 1. QUY TRÌNH 5 BƯỚC THIẾT KẾ TỔNG THỂ HLD VIETTEL

```mermaid
flowchart LR
    subgraph S_STEP_LEFT ["BƯỚC 1 & 2: YÊU CẦU, ĐỊNH CỠ TẢI VÀ KIẾN TRÚC"]
        direction TB
        ST1["BƯỚC 1: XÁC ĐỊNH YÊU CẦU & ĐỊNH CỠ TẢI HỆ THỐNG<br/>• Phân tích yêu cầu phi chức năng (Phần II)<br/>• Lập bảng định cỡ tải: Active users, Giao dịch/ngày, TPS, Concurrent<br/>• Cam kết độ sẵn sàng 99.9%, RTO ≤ 15 phút, RPO = 0"]
...
1. Áp dụng biểu mẫu chuẩn Viettel tại [hld_template.md](./resources/hld_template.md).
...
* [Quy chuẩn soạn thảo Thiết kế Tổng thể Viettel HLD](file:///Users/micro/Source/docsbase/.agents/rules/hld_authoring_rules.md)
* [Biểu mẫu khung HLD chuẩn Viettel BM.02](./resources/hld_template.md)
