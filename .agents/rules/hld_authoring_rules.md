...
Mục 3.1 của tài liệu HLD bắt buộc phải sử dụng **Mô hình Kiến trúc Phân lớp và Phân vùng Hệ thống Chuẩn Viettel (`flowchart TD`)** bao gồm 5 phân vùng an ninh độc lập và bảng đặc tả 5 cột chi tiết:
